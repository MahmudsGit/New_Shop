                                            ...
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="{{ route('product-details', ['id' => $brandProduct->id]) }}" class="new-gri" >
                                                                <div class="grid-img">
                                                    ...
                                                    <div class="women">
                                                        ...
                                                        <a href="{{ route('ad-to-cart-home',['id'=>$brandProduct->id]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        ...
                                        <div class="product-tab1">
                                            ...
                                            <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                ...
                                                <div class="women">
                                                    <h6><a href="#">{{ $brandProduct->product_name }}</a></h6>
                                                    <span class="size">Available</span>
                                                    <p>{{ $brandProduct->short_description }}</p>
                                                    <p ><del><em class="item_price">{{ $brandProduct->product_price }}</em></p>
                                                    <a href="{{ route('ad-to-cart-home',['id'=>$brandProduct->id]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
