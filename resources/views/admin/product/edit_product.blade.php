            ...
            <div class="col-xl-10 col-lg-10">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <h5 class="text-primary">Edit / Update Product</h5>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        {!! Form::open(['route'=>'update-product','method'=>'post','enctype'=>'multipart/form-data']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="short_description" class="form-control" rows="2">{{ $products->short_description }}</textarea>
                            <span class="text-danger">{{ $errors->has('short_description') ? $errors->first('short_description') : ' ' }}</span>
                        </div>
                        <div class="form-group">
                            <label for="long_description">Product Long Description</label>
                            <textarea type="text" id="editor" name="long_description" class="form-control" rows="6">{{ $products->long_description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="product_quantity" class="form-control" value="{{ $products->product_quantity }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_status" class="form-control">
                                ...
                                <option value="1" {{ $products->product_status ==1 ? 'Selected' : '' }} >Published</option>
                                <option value="0" {{ $products->product_status ==0 ? 'Selected' : '' }} >Unpublished</option>
                            </select>
                            <span class="text-danger">{{ $errors->has('product_status') ? $errors->first('product_status') : ' ' }}</span>
                        </div>
                        <input type="submit" name="product_btn" value="Update Product Info" class="btn btn-primary btn-block">
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
